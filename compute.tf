...
resource "aws_instance" "sample_ec2_hardcoded" {
  ...
  key_name      = "alan_ce_useast1" # change to your own keypair name
  subnet_id     = "subnet-037051b755de6deb5" # change to your own vpc subnet id
  associate_public_ip_address = true
  vpc_security_group_ids = [aws_security_group.ec2_sg.id]

  tags = {
    Name = "alanp-webserver-terraform"
  }
}
